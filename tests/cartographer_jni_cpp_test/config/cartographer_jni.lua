...
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.rotation_weight = 4e1
...
POSE_GRAPH.optimization_problem.local_slam_pose_rotation_weight = 0--54321 -- != 0 can causes map errors when rotating

-----------------TUNE THESE PARAMETERS FOR LOW LATENCY-------------------------------

------------Global SLAM------------
POSE_GRAPH.optimize_every_n_nodes = 3 -- Decrease
...
-- TRAJECTORY_BUILDER_2D.motion_filter.max_angle_radians = 0.01
...
TRAJECTORY_BUILDER_2D.submaps.grid_options_2d.resolution=0.1 -- Increase new option
--TRAJECTORY_BUILDER_2D.submaps.resolution=0.05 -- Increase old option

TRAJECTORY_BUILDER_2D.submaps.num_range_data = 30 -- Decrease
