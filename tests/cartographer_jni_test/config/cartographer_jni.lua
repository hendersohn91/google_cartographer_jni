...
TRAJECTORY_BUILDER_2D.min_range = 0.05 -- 0.
...
TRAJECTORY_BUILDER_2D.real_time_correlative_scan_matcher.translation_delta_cost_weight = 0.1 -- 1e-1
TRAJECTORY_BUILDER_2D.real_time_correlative_scan_matcher.rotation_delta_cost_weight = 0.1 -- 1e-1
-- TRAJECTORY_BUILDER_2D.ceres_scan_matcher.occupied_space_weight = 1.
-- TRAJECTORY_BUILDER_2D.ceres_scan_matcher.translation_weight = 10. -- 10.
-- TRAJECTORY_BUILDER_2D.ceres_scan_matcher.rotation_weight = 50. -- 40.
...
TRAJECTORY_BUILDER_2D.submaps.num_range_data = 30 -- 90
